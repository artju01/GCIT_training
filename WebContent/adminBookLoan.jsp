...
<script id="entry-template" type="text/x-handlebars-template">
  <tr>
	...
	<td align="center"><button type="button" class="btn btn-primary" onclick="javascript:launchModal('{{book.bookId}}','{{branch.branchId}}','{{borrower.cardNo}}','{{dueDate}}');">Edit</button></td>
  </tr>
</script>
...
<script>
	function launchModal(bookId, branchId, cardNo, dueDate) {
